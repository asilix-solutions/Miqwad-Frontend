 ...
 * Each row is a ProviderCard surface with hover lift, thumbnail, and action buttons.
  ...
  return (
    <ProviderCard padded={false} className="flex items-center gap-4 px-5 py-4">
      ...
      <div className="hidden items-center gap-6 sm:flex">
        ...
        <ProviderSkeleton variant="line" width={70} />
      ...
      {products.map((product, index) => {
        ...
        return (
          ...
          >
            ...
            >
              {/* Clickable area: thumbnail + name + desktop meta */}
              <div
                role="button"
                tabIndex={0}
              ...
              >
                ...
                {product.images?.[0] ? (
                  <img
                    ...
                    alt={name}
                    className="h-16 w-16 shrink-0 rounded-[var(--radius-sm)] border border-[var(--color-divider)] object-cover"
                  />
                ) : (
                  <div
                ...
                {/* Category · Price · Stock · Status — hidden on mobile */}
