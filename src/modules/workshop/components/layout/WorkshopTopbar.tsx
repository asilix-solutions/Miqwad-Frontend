/**
 * @file WorkshopTopbar.tsx
 *
 * Top navigation bar for the workshop provider area.
 * Includes language toggle, user avatar, and logout action.
 */
            ...
            <DropdownMenuTrigger asChild>
              ...
              >
                ...
                <Avatar className="h-9 w-9 bg-brand-100 text-brand-700">
                  ...
                  <AvatarFallback>{user.fullName?.charAt(0) ?? "W"}</AvatarFallback>
                </Avatar>
              </button>
            </DropdownMenuTrigger>
