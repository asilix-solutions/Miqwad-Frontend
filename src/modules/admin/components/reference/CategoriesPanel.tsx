 ...
 * @description Categories CRUD panel – table + add/edit/delete dialogs.
 ...
 * <Can> permission gating are preserved from the original AdminCategoriesPage.
 */
                ...
                return (
                  <div className="flex items-center gap-2">
                    <div
                      ...
                      style={{
                        backgroundColor: COLOR_MAP[cat.colorHint] || "#ccc",
                      }}
                    />
                    <span>
                      {t(
                        `superAdmin.categories.form.colorOptions.${cat.colorHint}`,
