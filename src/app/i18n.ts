...
const ar = {
  ...
  superAdmin: {
    ...
    escrow: {
      ...
      error: "تعذّر تحميل بيانات النزاعات",
      tabs: {
        open: "مفتوح",
      ...
      empty: {
        open: "لا توجد نزاعات مفتوحة",
        under_review: "لا توجد نزاعات قيد المراجعة",
        resolved: "لا توجد نزاعات محلولة",
        all: "لا توجد نزاعات",
      },
      detail: {
        title: "نزاع #{{orderId}}",
        notFound: "النزاع غير موجود",
        backToDisputes: "العودة للنزاعات",
        info: "معلومات النزاع",
        openedBy: "مقدم النزاع",
        amount: "المبلغ المتنازع عليه",
        createdAt: "تاريخ الفتح",
        reason: "سبب النزاع",
        resolution: "نتيجة الحسم",
        decision: "القرار",
        partialAmount: "المبلغ المرجع",
        note: "ملاحظات الإدارة",
        resolvedAt: "تاريخ الحسم",
        evidence: "الأدلة المرفقة",
        noEvidence: "لا توجد أدلّة",
        viewEvidence: "عرض",
      },
      resolve: {
        button: "حسم النزاع",
        title: "حسم النزاع #{{orderId}}",
        description: "يُرجى مراجعة الأدلة جيدًا قبل اتخاذ القرار، لأن هذا الإجراء مالي ولا يمكن التراجع عنه.",
        decisionLabels: "القرار المالي",
        releaseToProvider: "تحرير للمزود",
        refundToCustomer: "إرجاع للعميل",
        partialRefund: "إرجاع جزئي",
        partialAmountLabel: "المبلغ المرجع للعميل (ر.س)",
        partialAmountPlaceholder: "الحد الأقصى: {{max}}",
        noteLabel: "ملاحظات وتبرير القرار",
        notePlaceholder: "اكتب سبب القرار وتفاصيله...",
        summary: {
          release: "سيتم تحرير {{amount}} للمزود {{provider}}",
          refund: "سيتم إرجاع {{amount}} للعميل",
          partial: "سيتم إرجاع {{partialAmount}} للعميل وتحرير الباقي ({{remainingAmount}}) للمزود {{provider}}",
        },
        cancel: "إلغاء",
        confirm: "تأكيد الحسم",
        success: "تم حسم النزاع بنجاح",
        decision: {
          release_to_provider: "تحرير للمزود",
          refund_to_customer: "إرجاع للعميل",
    ...
    settings: {
      ...
      tabs:{ general:"عام", business:"الأعمال", contact:"التواصل", flags:"الميزات" },
      ...
      business:{ heading:"إعدادات الأعمال",
        defaultCommissionRate:"نسبة العمولة الافتراضية", commissionHint:"النسبة المئوية المقتطعة من كل عملية",
        minWithdrawalAmount:"الحد الأدنى للسحب", minWithdrawalHint:"أقل مبلغ يمكن للمزوّد سحبه",
        settlementHoldDays:"أيام احتجاز التسوية", settlementHoldHint:"عدد الأيام قبل إتاحة التسوية",
        escrowAutoReleaseDays:"أيام الإفراج التلقائي للضمان", escrowHint:"عدد الأيام ثم يُفرج تلقائياً",
        saved:"تم حفظ إعدادات الأعمال" },
  ...
  superAdmin: {
    ...
    escrow: {
      ...
      resolve: {
        ...
        title: "Resolve Dispute #{{orderId}}",
        description: "Please review the evidence carefully before deciding. This is a financial action and cannot be undone.",
        decisionLabels: "Financial Decision",
        releaseToProvider: "Release to Provider",
        refundToCustomer: "Refund to Customer",
        partialRefund: "Partial Refund",
        partialAmountLabel: "Refund Amount to Customer (SAR)",
        partialAmountPlaceholder: "Max: {{max}}",
        noteLabel: "Notes & Justification",
        notePlaceholder: "Write the reason and details for this decision...",
        summary: {
          release: "{{amount}} will be released to {{provider}}",
          refund: "{{amount}} will be refunded to the customer",
          partial: "{{partialAmount}} will be refunded to the customer, and the remaining {{remainingAmount}} will be released to {{provider}}",
        },
        cancel: "Cancel",
    ...
    settings: {
      ...
      tabs:{ general:"General", business:"Business", contact:"Contact", flags:"Features" },
      ...
      business:{ heading:"Business Settings",
        defaultCommissionRate:"Default Commission Rate", commissionHint:"Percentage deducted from each transaction",
        minWithdrawalAmount:"Min Withdrawal Amount", minWithdrawalHint:"Minimum amount provider can withdraw",
        settlementHoldDays:"Settlement Hold Days", settlementHoldHint:"Days before settlement is available",
        escrowAutoReleaseDays:"Escrow Auto Release Days", escrowHint:"Days before escrow is auto-released",
