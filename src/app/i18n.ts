...
const ar = {
  common: {
    ...
    maxLengthExceeded: "تجاوزت الحد الأقصى المسموح للأحرف",
    mustBeZeroOrMore: "يجب أن تكون القيمة صفراً أو أكثر",
  ...
  accountProfile: {
    ...
    image: {
      change: "تغيير الصورة الشخصية",
      remove: "حذف الصورة الشخصية",
      uploadSuccess: "تم تحديث الصورة الشخصية بنجاح",
      uploadFailed: "تعذّر رفع الصورة الشخصية",
      removeSuccess: "تم حذف الصورة الشخصية",
      removeFailed: "تعذّر حذف الصورة الشخصية",
      loadFailed: "تعذّر تحميل الصورة الشخصية",
      errors: {
        invalidType: "الملف يجب أن يكون صورة",
        tooLarge: "حجم الصورة يجب ألا يتجاوز {{size}} ميجابايت",
      },
    },
    addresses: {
      ...
      emptyDescription: "أضف أول عنوان لك ليظهر هنا",
      createSuccess: "تمت إضافة العنوان بنجاح",
      updateSuccess: "تم تعديل العنوان بنجاح",
      saveFailed: "تعذّر حفظ العنوان",
      deleteConfirmTitle: "حذف العنوان",
      deleteConfirm: "حذف العنوان",
    ...
    workingHours: {
      ...
      previewFormat: "{{fromDay}} – {{toDay}}، {{fromTime}} – {{toTime}}",
      save: "حفظ ساعات العمل",
      saveSuccess: "تم حفظ ساعات العمل بنجاح",
      saveFailed: "تعذّر حفظ ساعات العمل",
      loadFailed: "تعذّر تحميل ساعات العمل",
      validation: {
        dayRangeInvalid: "يجب ألا يكون يوم الانتهاء قبل يوم البدء",
        timeRangeInvalid: "يجب أن تكون ساعة الانتهاء بعد ساعة البدء",
      },
    },
  },
  discovery: {
  ...
  invoices: {
    title: "الفواتير",
    subtitle: "الفواتير الصادرة وتفاصيلها المالية",
    colCode: "رقم الفاتورة",
    colName: "العميل",
    colAmount: "الإجمالي",
    colDate: "تاريخ الإصدار",
    sortLabel: "ترتيب حسب",
    sortDefault: "الترتيب الافتراضي",
    sortHighest: "الأعلى إجمالًا",
    sortLowest: "الأقل إجمالًا",
    empty: {
      title: "لا توجد فواتير للعرض",
      description: "تظهر الفواتير الصادرة في هذا السجل.",
    },
    errorTitle: "تعذر تحميل الفواتير",
    errorDescription: "تعذر إكمال الطلب. يرجى إعادة المحاولة.",
    retry: "إعادة المحاولة",
    detailTitle: "فاتورة",
    backToList: "العودة إلى الفواتير",
    notFoundTitle: "الفاتورة غير موجودة",
    notFoundDescription: "تحقق من رابط الفاتورة أو عُد إلى سجل الفواتير.",
    unavailable: "غير متوفر",
    noOrder: "لا يوجد مرجع طلب",
    orderReference: "مرجع الطلب",
    supplyDate: "تاريخ التوريد",
    totalQuantity: "إجمالي الكمية",
    recordCount: "عدد الفواتير: {{count}}",
    loading: "جارٍ تحميل الفواتير…",
    pagination: "صفحات الفواتير",
    pageOf: "الصفحة {{page}} من {{total}}",
    facility: "المنشأة / البائع",
    buyer: "العميل / المشتري",
    partyName: "الاسم المسجل",
    taxId: "رقم التسجيل الضريبي",
    register: "السجل التجاري",
    address: "العنوان",
    noBuyerFiscal: "لم تُقدَّم بيانات ضريبية للمشتري.",
    noLines: "لم تُقدَّم بنود لهذه الفاتورة.",
    linesAndQuantity: "عدد البنود: {{lines}} · إجمالي الكمية: {{quantity}}",
    scrollItems: "مرّر الجدول أفقيًا لعرض جميع مبالغ البنود.",
    qrTitle: "رمز الفاتورة",
    qrUnavailable: "تعذر عرض رمز الفاتورة.",
    sections: {
      lineItems: "بنود الفاتورة",
      taxBreakdown: "الملخص المالي",
    },
    line: {
      service: "الخدمة",
      provider: "مقدم الخدمة",
  ...
  orders: {
    ...
    detail: {
      ...
      addressDescription: "وصف الموقع",
      addressShortNumber: "الرقم المختصر",
  ...
  superAdmin: {
    ...
    ads: {
      ...
      card: {
        ...
        openLink: "فتح {{host}} في تبويب جديد",
        quickToggleLabel: "تبديل حالة تفعيل الإعلان",
      },
      form: {
        ...
        deepLinkLabel: "الرابط",
        deepLinkPlaceholder: "https://example.com",
        testLink: "تجربة الرابط",
        imagePlaceholder: "اضغط لاختيار صورة",
        imageDragHint: "أو اسحب الصورة وأفلتها هنا",
        imageChange: "تغيير الصورة",
        imageRemove: "إزالة الصورة المختارة",
        imageHint: "PNG أو JPG، حتى {{size}} ميجابايت",
        isActive: "مُفعّل",
        isActiveHintOn: "سيظهر هذا الإعلان للمستخدمين",
        isActiveHintOff: "لن يظهر هذا الإعلان للمستخدمين",
        saving: "جارٍ الحفظ",
      },
      validation: {
        titleRequired: "العنوان مطلوب",
        titleTooLong: "العنوان طويل جداً",
        deepLinkRequired: "الرابط مطلوب",
        deepLinkInvalid: "رابط غير صالح",
        imageRequired: "صورة الإعلان مطلوبة",
        imageInvalidType: "يجب اختيار ملف صورة",
        imageTooLarge: "حجم الصورة يجب ألا يتجاوز {{size}} ميجابايت",
      },
      toasts: {
    ...
    plans: {
      title: "خطط الاشتراك",
      subtitle: "إدارة خطط الاشتراك المتاحة لمزودي الخدمات",
      add: "إضافة خطة",
      edit: "تعديل الخطة",
      columns: {
        name: "الاسم",
      ...
      errorTitle: "تعذّر تحميل خطط الاشتراك",
      empty: {
        title: "لا توجد خطط اشتراك بعد",
        description: "أنشئ أول خطة اشتراك لتحديد الأسعار ودورات الفوترة لمزودي الخدمات.",
      },
      card: {
        quickToggleLabel: "تفعيل أو تعطيل الخطة",
      },
      toggle: {
        activate: "تفعيل",
        deactivate: "تعطيل",
      ...
      toasts: {
        activated: "تم تفعيل الخطة",
        deactivated: "تم تعطيل الخطة",
        toggleFailed: "تعذّر تحديث حالة الخطة",
        created: "تمت إضافة الخطة بنجاح",
        updated: "تم تعديل الخطة بنجاح",
      },
      form: {
        createTitle: "إضافة خطة اشتراك",
        editTitle: "تعديل خطة الاشتراك",
        nameLabel: "اسم الخطة",
        namePlaceholder: "مثال: الخطة الأساسية",
        descriptionLabel: "الوصف",
        descriptionPlaceholder: "وصف مختصر لمزايا الخطة (اختياري)",
  ...
  dealer: {
    ...
    offers: {
      ...
      subtitle: "عروض الخصم التي تقدّمها على منتجاتك خلال فترة محددة",
      search: "ابحث باسم العرض أو الخدمة...",
      emptyTitle: "لا توجد عروض بعد",
      emptyDescription: "ستظهر هنا عروض الخصم التي تنشئها على منتجاتك",
      noResultsTitle: "لا توجد نتائج",
      noResultsDescription: "جرّب تعديل كلمة البحث",
      errorTitle: "تعذّر تحميل العروض",
      untitled: "عرض بدون عنوان",
      unnamedService: "خدمة غير مسماة",
      summary: "{{count}} خدمات · خصم حتى {{amount}}",
      ...
      notFoundDesc: "تعذّر العثور على العرض المطلوب",
      backToOffers: "العودة للعروض",
      linesHeading: "بنود الخصم",
      servicesCount: "{{count}} خدمات",
      colService: "الخدمة",
      colOriginalPrice: "السعر الأصلي",
      colDiscount: "الخصم",
      colFinalPrice: "السعر النهائي",
      noLines: "لا توجد بنود خصم في هذا العرض",
      totalSaving: "إجمالي التوفير",
      createCta: "إنشاء عرض",
      editCta: "تعديل",
      form: {
        createTitle: "إنشاء عرض ترويجي",
        createSubtitle: "حدّد عنواناً وفترة زمنية وبنود الخصم على خدماتك",
        editTitle: "تعديل العرض الترويجي",
        editSubtitle: "حدّث عنوان العرض أو فترته أو بنود الخصم",
        titleLabel: "عنوان العرض",
        titlePlaceholder: "مثال: خصومات نهاية الأسبوع",
        startDateLabel: "تاريخ البداية",
        endDateLabel: "تاريخ النهاية",
        errorBannerTitle: "تعذّر حفظ العرض",
        lineEditor: {
          heading: "بنود الخصم",
          hint: "بند واحد على الأقل",
          serviceLabel: "الخدمة",
          servicePlaceholder: "اختر خدمة",
          discountLabel: "قيمة الخصم (ر.س)",
          addLine: "إضافة بند",
          removeLine: "حذف البند",
          servicesLoadError: "تعذّر تحميل خدماتك، حاول إعادة تحميل الصفحة",
        },
        preview: {
          label: "{{original}} ← {{discounted}}",
          invalid: "قيمة خصم غير صالحة: يجب أن تكون أكبر من صفر ولا تتجاوز سعر الخدمة",
        },
        validation: {
          titleRequired: "عنوان العرض مطلوب",
          titleMax: "العنوان طويل جداً",
          ...
          itemsMin: "أضف بند خصم واحداً على الأقل",
          lineServiceRequired: "اختر خدمة لهذا البند",
          discountRequired: "قيمة الخصم مطلوبة",
          discountPositive: "قيمة الخصم يجب أن تكون أكبر من صفر",
          discountExceedsPrice: "قيمة الخصم يجب ألا تتجاوز سعر الخدمة",
        },
        toasts: {
      ...
      delete: {
        cta: "حذف",
        title: "حذف العرض",
        body: "سيتم حذف العرض «{{title}}» نهائياً. لا يمكن التراجع عن هذا الإجراء.",
        confirm: "حذف العرض",
        toastSuccess: "تم حذف العرض",
        toastError: "تعذّر حذف العرض",
      },
    },
    nav: {
      dashboard: "لوحة التحكم",
    ...
    orders: {
      ...
      filterAll: "الكل",
      unknownCustomer: "عميل غير معروف",
      errorDescription: "تعذّر تحميل الطلبات",
      colOrder: "رقم الطلب",
      colCustomer: "العميل",
      colItems: "المنتجات",
      ...
      detail: {
        ...
        commissionNote: "تقديري — يُحتسب مؤقتًا لحين ربط العمولة بالنظام",
        address: "عنوان التوصيل",
        viewOnMap: "عرض على الخريطة",
  ...
  scrap: {
    ...
    offer: {
      ...
      descriptionLabel: "وصف العرض (اختياري)",
      isCompatibleWithLabel: "التوافق مع الموديلات (اختياري)",
      priceComingSoon: "سيتم تفعيل حقل السعر قريباً",
      photosComingSoon: "سيتم تفعيل رفع صور العرض قريباً",
      comingSoonBadge: "قريباً",
      editTitle: "تعديل العرض",
      updateSuccess: "تم تحديث العرض بنجاح",
      deleteConfirmTitle: "حذف العرض",
      deleteConfirmBody: "هل تريد حذف هذا العرض؟ لا يمكن التراجع عن هذا الإجراء.",
      deleteSuccess: "تم حذف العرض بنجاح",
      providerServiceLabel: "القطعة المقدَّمة",
      providerServicePlaceholder: "اختر إحدى قطعك…",
      startDateLabel: "تاريخ البدء",
      endDateLabel: "تاريخ الانتهاء",
      noPartsTitle: "لا توجد قطع متاحة",
      noPartsDescription: "أضف قطعاً من صفحة «قطعي» أولاً ثم عد لتقديم العرض",
      goToParts: "الذهاب إلى قطعي",
      namePlaceholder: "مثال: مضخة ماء تويوتا كامري — أصلية",
      notesLabel: "ملاحظات للعميل (اختياري)",
      notesPlaceholder: "حالة القطعة، الضمان، تفاصيل إضافية…",
      isCompatibleWithPlaceholder: "مثال: تويوتا كامري 2018–2022",
      isCompatibleWithHint: "اختياري — الموديلات المتوافقة مع هذه القطعة",
      filesLabel: "صور أو مرفقات (اختياري)",
      filesDropHint: "اسحب الملفات هنا",
      filesBrowseHint: "أو اضغط للاختيار من جهازك",
      saveEdit: "حفظ التعديلات",
      validation: {
        pricePositive: "يجب أن يكون السعر أكبر من صفر",
        nameRequired: "يرجى إدخال اسم العرض",
        nameTooLong: "الاسم طويل جداً (150 حرفاً كحد أقصى)",
        notesTooLong: "الملاحظات طويلة جداً (2000 حرف كحد أقصى)",
        isCompatibleWithTooLong: "النص طويل جداً (500 حرف كحد أقصى)",
        titleRequired: "يرجى إدخال عنوان العرض",
        providerServiceRequired: "يرجى اختيار قطعة",
        startDateRequired: "يرجى تحديد تاريخ البدء",
        endDateRequired: "يرجى تحديد تاريخ الانتهاء",
        endDateAfterStart: "يجب أن يكون تاريخ الانتهاء بعد تاريخ البدء أو مساوياً له",
      },
    },
    partRequests: {
      title: "طلبات القطع",
      ...
      brandFilterLabel: "الماركة",
      brandFilterAll: "كل الماركات",
      notOfferedFilterLabel: "لم أُقدّم عرضاً بعد",
  ...
  chat: {
    title: {
      workshop: "محادثات الورشة",
      scrap: "محادثات التشليح",
    },
    subtitle: {
      workshop: "تواصل مع عملاء الورشة عبر منصة مقود",
      scrap: "تواصل مع عملاء التشليح عبر منصة مقود",
    },
    ...
    connection: {
      ...
      disconnected: "غير متصل بالمحادثة",
    },
    status: {
      connected: "متصل",
    ...
    newChat: {
      ...
      submit: "بدء",
      invalidId: "أدخل رقم مستخدم صحيحاً",
      selfId: "لا يمكنك بدء محادثة مع نفسك",
    },
    errors: {
      invalidReceiver: "رقم المستلم غير صالح",
      cannotSendToSelf: "لا يمكنك إرسال رسالة إلى نفسك",
      empty: "لا يمكن إرسال رسالة فارغة",
      tooLong: "الرسالة تتجاوز الحد المسموح (٢٠٠٠ حرف)",
      notAuthenticated: "انتهت الجلسة، الرجاء تسجيل الدخول من جديد",
...
const en: typeof ar = {
  common: {
    ...
    maxLengthExceeded: "Exceeds the maximum allowed length",
    mustBeZeroOrMore: "Value must be zero or more",
  ...
  accountProfile: {
    ...
    image: {
      ...
      removeFailed: "Failed to remove profile photo",
      loadFailed: "Failed to load profile photo",
      errors: {
        invalidType: "The file must be an image",
        tooLarge: "Image size must not exceed {{size}} MB",
      },
    },
    addresses: {
      ...
      emptyDescription: "Add your first address to see it here",
    ...
    workingHours: {
      ...
      saveSuccess: "Working hours saved successfully",
      saveFailed: "Failed to save working hours",
      loadFailed: "Failed to load working hours",
      validation: {
        dayRangeInvalid: "End day must not be before start day",
  ...
  invoices: {
    title: "Invoices",
    subtitle: "Issued invoices and their financial details",
    colCode: "Invoice number",
    colName: "Customer",
    colAmount: "Total",
    colDate: "Issue date",
    sortLabel: "Sort by",
    ...
    empty: {
      ...
      description: "Issued invoices will appear in this register.",
    },
    ...
    notFoundDescription: "Check the invoice link or return to the invoice register.",
    unavailable: "Not provided",
    noOrder: "No order reference",
    ...
    facility: "Facility / seller",
    buyer: "Customer / buyer",
    partyName: "Registered name",
    taxId: "Tax registration number",
    register: "Commercial register",
    address: "Address",
    noBuyerFiscal: "Buyer fiscal information was not provided.",
    noLines: "No invoice lines were provided.",
    linesAndQuantity: "Lines: {{lines}} · Total quantity: {{quantity}}",
    scrollItems: "Scroll horizontally to view all line amounts.",
    qrTitle: "Invoice QR code",
    qrUnavailable: "The invoice QR code could not be displayed.",
    sections: {
      lineItems: "Invoice lines",
      taxBreakdown: "Financial summary",
    },
    line: {
      service: "Service",
      provider: "Provider",
  ...
  orders: {
    ...
    detail: {
      ...
      addressShortNumber: "Short number",
  ...
  superAdmin: {
    ...
    ads: {
      ...
      card: {
        noImage: "No image",
        openLink: "Open {{host}} in a new tab",
        quickToggleLabel: "Toggle advertisement active status",
      },
      form: {
        createTitle: "Create Advertisement",
        editTitle: "Edit Advertisement",
        titleLabel: "Title",
        titlePlaceholder: "Enter the ad title",
        deepLinkLabel: "Link",
        deepLinkPlaceholder: "https://example.com",
        testLink: "Test link",
        imagePlaceholder: "Click to choose an image",
        imageDragHint: "or drag and drop it here",
        imageChange: "Change image",
        imageRemove: "Remove selected image",
        imageHint: "PNG or JPG, up to {{size}} MB",
        isActive: "Active",
        isActiveHintOn: "This ad will be shown to users",
        isActiveHintOff: "This ad will not be shown to users",
        saving: "Saving…",
      },
      validation: {
        titleRequired: "Title is required",
        titleTooLong: "Title is too long",
        deepLinkRequired: "Link is required",
        deepLinkInvalid: "Invalid link",
        imageRequired: "Ad image is required",
        imageInvalidType: "Please select an image file",
        imageTooLarge: "Image size must not exceed {{size}} MB",
      },
      toasts: {
    ...
    plans: {
      ...
      subtitle: "Manage the subscription plans available to service providers",
      add: "Add plan",
      edit: "Edit plan",
      columns: {
        name: "Name",
      ...
      toasts: {
        ...
        toggleFailed: "Could not update the plan status",
      ...
      form: {
        ...
        nameLabel: "Plan name",
        namePlaceholder: "e.g. Basic plan",
        descriptionLabel: "Description",
        descriptionPlaceholder: "A short description of what the plan includes (optional)",
  ...
  dealer: {
    ...
    offers: {
      ...
      subtitle: "Discount offers you run on your products for a set time window",
      search: "Search by offer or service name...",
      emptyTitle: "No offers yet",
      emptyDescription: "Discount offers you create on your products will appear here",
      noResultsTitle: "No results",
      noResultsDescription: "Try adjusting your search",
      errorTitle: "Couldn't load offers",
      untitled: "Untitled offer",
      unnamedService: "Unnamed service",
      summary: "{{count}} services · up to {{amount}} off",
      ...
      notFoundDesc: "We couldn't find the offer you're looking for",
      backToOffers: "Back to offers",
      linesHeading: "Discount lines",
      servicesCount: "{{count}} services",
      colService: "Service",
      colOriginalPrice: "Original price",
      colDiscount: "Discount",
      colFinalPrice: "Final price",
      noLines: "This offer has no discount lines",
      totalSaving: "Total saving",
      createCta: "Create offer",
      editCta: "Edit",
      form: {
        createTitle: "Create promotional offer",
        createSubtitle: "Set a title, a date window, and the discount lines on your services",
        editTitle: "Edit promotional offer",
        editSubtitle: "Update the offer's title, window, or discount lines",
        titleLabel: "Offer title",
        titlePlaceholder: "e.g. Weekend discounts",
        startDateLabel: "Start date",
        endDateLabel: "End date",
        errorBannerTitle: "Couldn't save the offer",
        lineEditor: {
          heading: "Discount lines",
          hint: "At least one line",
          serviceLabel: "Service",
          servicePlaceholder: "Choose a service",
          discountLabel: "Discount amount (SAR)",
          addLine: "Add line",
          removeLine: "Remove line",
          servicesLoadError: "Couldn't load your services — try reloading the page",
        },
        preview: {
          label: "{{original}} → {{discounted}}",
          invalid: "Invalid discount: must be greater than zero and not exceed the service price",
        },
        validation: {
          ...
          itemsMin: "Add at least one discount line",
          lineServiceRequired: "Choose a service for this line",
          discountRequired: "Discount amount is required",
          discountPositive: "Discount amount must be greater than zero",
          discountExceedsPrice: "Discount amount must not exceed the service price",
        },
        toasts: {
          created: "Offer created",
          updated: "Offer updated",
          saveFailed: "Couldn't save the offer",
        },
      },
      delete: {
        cta: "Delete",
        title: "Delete offer",
        body: "The offer “{{title}}” will be permanently deleted. This action cannot be undone.",
        confirm: "Delete offer",
        toastSuccess: "Offer deleted",
        toastError: "Couldn't delete the offer",
      },
    },
    nav: {
      dashboard: "Dashboard",
    ...
    orders: {
      ...
      detail: {
        ...
        commissionNote: "Estimated — computed temporarily until commission is wired to the backend",
        address: "Delivery address",
        viewOnMap: "View on map",
        noItems: "No products on this order",
  ...
  scrap: {
    ...
    offer: {
      ...
      descriptionLabel: "Offer Description (optional)",
      isCompatibleWithLabel: "Compatible Models (optional)",
      priceComingSoon: "Price will be enabled soon",
      photosComingSoon: "Offer photo upload will be enabled soon",
      comingSoonBadge: "Coming soon",
      editTitle: "Edit Offer",
      updateSuccess: "Offer updated successfully",
      deleteConfirmTitle: "Delete Offer",
      deleteConfirmBody: "Delete this offer? This action cannot be undone.",
      deleteSuccess: "Offer deleted successfully",
      providerServiceLabel: "Offered Part",
      providerServicePlaceholder: "Choose one of your parts…",
      startDateLabel: "Start Date",
      endDateLabel: "End Date",
      noPartsTitle: "No parts available",
      noPartsDescription: "Add parts from your My Parts page first, then return to submit an offer",
      goToParts: "Go to My Parts",
      namePlaceholder: "e.g. Toyota Camry water pump — OEM",
      notesLabel: "Notes to customer (optional)",
      notesPlaceholder: "Condition, warranty, extra details…",
      isCompatibleWithPlaceholder: "e.g. Toyota Camry 2018–2022",
      isCompatibleWithHint: "Optional — models this part fits",
      filesLabel: "Photos or attachments (optional)",
      filesDropHint: "Drag files here",
      filesBrowseHint: "or click to choose from your device",
      saveEdit: "Save changes",
      validation: {
        pricePositive: "Price must be greater than zero",
        nameRequired: "Please enter an offer name",
        nameTooLong: "Name is too long (150 characters max)",
        notesTooLong: "Notes are too long (2000 characters max)",
        isCompatibleWithTooLong: "Text is too long (500 characters max)",
        titleRequired: "Please enter an offer title",
        providerServiceRequired: "Please select a part",
        startDateRequired: "Please set a start date",
        endDateRequired: "Please set an end date",
    ...
    partRequests: {
      ...
      brandFilterAll: "All Brands",
      notOfferedFilterLabel: "Not offered on yet",
  ...
  chat: {
    title: {
      workshop: "Workshop Chats",
      scrap: "Scrap Chats",
    },
    subtitle: {
      workshop: "Connect with workshop customers through Maqwad",
      scrap: "Connect with scrap customers through Maqwad",
    },
    ...
    newChat: {
      ...
      placeholder: "User ID",
      submit: "Start",
      invalidId: "Enter a valid user ID",
      selfId: "You can't start a chat with yourself",
    },
    errors: {
      invalidReceiver: "Invalid recipient ID",
      cannotSendToSelf: "You can't send a message to yourself",
      empty: "Message can't be empty",
      tooLong: "Message exceeds the 2000-character limit",
