...
const ar = {
  ...
  invoices: {
    title: "الفوترة",
    subtitle: "سجل الفواتير الصادرة عبر المنصة",
    colCode: "رقم الفاتورة",
    colName: "الاسم",
    colAmount: "المبلغ",
    colDate: "التاريخ",
    sortLabel: "ترتيب حسب",
    codeLabel: "فاتورة {{code}}",
    empty: {
      title: "لا توجد فواتير بعد",
      description: "ستظهر الفواتير هنا فور صدور أول فاتورة على المنصة.",
    },
    ...
    notFoundDescription: "لم نتمكن من العثور على فاتورة بهذا الرقم. قد تكون محذوفة أو أن الرابط غير صحيح.",
...
const en: typeof ar = {
  ...
  invoices: {
    title: "Invoices",
    subtitle: "Record of invoices issued across the platform",
    colCode: "Invoice No.",
    colName: "Name",
    colAmount: "Amount",
    colDate: "Date",
    ...
    empty: {
      ...
      description: "Invoices will appear here as soon as the first one is issued on the platform.",
    },
    ...
    notFoundDescription: "We couldn't find an invoice with this number. It may have been removed, or the link is incorrect.",
    comingSoonLabel: "Coming soon",
    sections: {
      lineItems: "Line items",
      taxBreakdown: "Tax / VAT breakdown",
      parties: "Parties",
      payment: "Payment",
    },
    tax: {
